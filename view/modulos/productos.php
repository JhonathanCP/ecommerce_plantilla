...
<figure class="banner">
	...
	<img src="http://localhost/backend/view/img/banner/default.jpg" class="img-responsive" width="100%">	
				...
				<div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="btn-group">
                            ...
                            Ordenar Productos <span class="caret">
                            </span></button>
    ...
    <div class="container">
        <div class="row">
            <ul class="breadcrumb fondoBreadCrumb lead text-uppercase">
                <li><a href="<?php echo $url; ?>">INCIO</a></li>
			...
			/*=============================================
			LLAMADO DE PRODUCOTS DE CATEGORIAS, SUBCATEGORIAS Y DESTACADOS
			==============================================*/
